        ...
        >
          {SITE_CONFIG.projects.map((project, index) => (
            <motion.div
              ...
              className="group relative h-[200px] grid grid-cols-1 md:grid-cols-2 border border-white/10 rounded-none overflow-hidden transition-all duration-300 hover:border-white/20"
            >
              {/* ─── LEFT: TEXT ─── */}
              <div className="flex flex-col justify-between p-6 md:p-8 bg-card h-full">
                <div>
